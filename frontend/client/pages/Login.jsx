      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="space-y-3">
          <SocialButton
            ...
            icon={
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <path d="M4.86634 11.7417C4.68301 11.1917 4.57467 10.6084 4.57467 10.0001C4.57467 9.39172 4.68301 8.80839 4.86634 8.25839V5.89172H1.81634C1.19134 7.12506 0.833008 8.51672 0.833008 10.0001C0.833008 11.4834 1.19134 12.8751 1.81634 14.1084L4.19134 12.2584L4.86634 11.7417Z" fill="#FBBC05" />
                <path d="M9.99974 4.48337C11.3497 4.48337 12.5497 4.95004 13.5081 5.85004L16.1331 3.22504C14.5414 1.74171 12.4747 0.833374 9.99974 0.833374C6.41641 0.833374 3.32474 2.89171 1.81641 5.89171L4.86641 8.25837C5.59141 6.09171 7.61641 4.48337 9.99974 4.48337Z" fill="#EA4335" />
              </svg>
            }
          >
            Google로 로그인
          ...
          <SocialButton
            ...
            icon={
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M10 2.5C14.8325 2.5 18.75 5.55333 18.75 9.32083C18.75 13.0875 14.8325 16.1408 10 16.1408C9.51881 16.1411 9.0381 16.1105 8.56083 16.0492L4.8875 18.4517C4.47 18.6725 4.3225 18.6483 4.49417 18.1075L5.2375 15.0425C2.8375 13.8258 1.25 11.7175 1.25 9.32083C1.25 5.55417 5.1675 2.5 10 2.5Z" fill="black" />
              </svg>
            }
          >
            카카오로 로그인
            ...
            icon={
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <g clipPath="url(#clip0_21_410)">
                  <path d="M13.5608 10.7042L6.14667 0H0V20H6.43833V9.29667L13.8533 20H20V0H13.5608V10.7042Z" fill="black" />
                </g>
                <defs>
        ...
        <div className="text-center mt-8">
          <button onClick={handleSignUp} className="text-gray-500 text-sm hover:text-gray-700 transition-colors">
            회원가입
          </button>
        </div>
      </div>
