    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">비밀번호를 설정해주세요</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Password Field */}
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-gray-900 mb-2">비밀번호</label>
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-900 mb-2">비밀번호 확인</label>
            <div className="relative">
              <input
